        ...
        <Grid display="inline-flex">
          ...
          <Grid item xs={3}>
            <Typography style={{ textAlign: "center" }}>
              Form No: 25 <br />
              (Prescribed under rule 103 of the Madras Factory Rules 1950 &
              under G. O. No. 2759 of 1959)
              <br />
              chennai-600 042
            </Typography>
          </Grid>
          ...
          <Table>
            <TableBody>
              <TableRow sx={{ border: "2px solid black", padding: "5px" }}>
                <TableCell sx={{ border: "2px solid black", padding: "5px" }}>
                  s.no
                </TableCell>
                <TableCell sx={{ border: "2px solid black", padding: "5px" }}>
                  name of the worker
                ...
                <TableCell sx={{ border: "2px solid black", padding: "5px" }}>
                  Designation<br></br>nature of worker
                </TableCell>
                <TableCell sx={{ border: "2px solid black", padding: "5px" }}>
                  date of birth to be supported by extra from birth register
                </TableCell>
                <TableCell sx={{ border: "2px solid black", padding: "5px" }}>
                ...
                {[...Array(30).keys()].map((day) => (
                  <TableCell
                    key={day + 1}
                    sx={{ border: "2px solid black", padding: "5px" }}>
                    {day + 1}
                  </TableCell>
                ))}
              </TableRow>
              {rolldata.map((entry, index) => (
                <TableRow key={index}>
                  ...
                  <TableCell sx={{ border: "2px solid black", padding: "5px" }}>
                    {JSON.stringify(entry.father_name).replace(/"/g, "") == "{}"
                      ? "no data"
                      : JSON.stringify(entry.father_name).replace(/"/g, "")}
                  </TableCell>
                  <TableCell sx={{ border: "2px solid black", padding: "5px" }}>
                    {JSON.stringify(entry.designation).replace(/"/g, "") == "{}"
                      ? "no data"
                      : JSON.stringify(entry.designation).replace(/"/g, "")}
                  </TableCell>
                  <TableCell sx={{ border: "2px solid black", padding: "5px" }}>
                    {JSON.stringify(entry.dob).replace(/"/g, "") == "{}"
                      ? "no data"
                      : JSON.stringify(entry.dob).replace(/"/g, "")}
                  </TableCell>
                  <TableCell sx={{ border: "2px solid black", padding: "5px" }}>
                    {JSON.stringify(entry.Branch_Name).replace(/"/g, "") == "{}"
                      ? "no data"
                      : JSON.stringify(entry.Branch_Name).replace(/"/g, "")}
                  </TableCell>
                  <TableCell sx={{ border: "2px solid black", padding: "5px" }}>
                  ...
                  <TableCell sx={{ border: "2px solid black", padding: "5px" }}>
                    {renderStatus(
                      JSON.stringify(entry.day_1).replace(/"/g, "")
                    )}
                  </TableCell>
                  <TableCell sx={{ border: "2px solid black", padding: "5px" }}>
                    {renderStatus(
                      JSON.stringify(entry.day_2).replace(/"/g, "")
                    )}
                  </TableCell>
                  <TableCell sx={{ border: "2px solid black", padding: "5px" }}>
                    {renderStatus(
                      JSON.stringify(entry.day_3).replace(/"/g, "")
                    )}
                  </TableCell>
                  <TableCell sx={{ border: "2px solid black", padding: "5px" }}>
                    {renderStatus(
                      JSON.stringify(entry.day_4).replace(/"/g, "")
                    )}
                  </TableCell>
                  <TableCell sx={{ border: "2px solid black", padding: "5px" }}>
                    {renderStatus(
                      JSON.stringify(entry.day_5).replace(/"/g, "")
                    )}
                  </TableCell>
                  <TableCell sx={{ border: "2px solid black", padding: "5px" }}>
                    {renderStatus(
                      JSON.stringify(entry.day_6).replace(/"/g, "")
                    )}
                  </TableCell>
                  <TableCell sx={{ border: "2px solid black", padding: "5px" }}>
                    {renderStatus(
                      JSON.stringify(entry.day_7).replace(/"/g, "")
                    )}
                  </TableCell>
                  <TableCell sx={{ border: "2px solid black", padding: "5px" }}>
                    {renderStatus(
                      JSON.stringify(entry.day_8).replace(/"/g, "")
                    )}
                  </TableCell>
                  <TableCell sx={{ border: "2px solid black", padding: "5px" }}>
                    {renderStatus(
                      JSON.stringify(entry.day_9).replace(/"/g, "")
                    )}
                  </TableCell>
                  <TableCell sx={{ border: "2px solid black", padding: "5px" }}>
                    {renderStatus(
                      JSON.stringify(entry.day_10).replace(/"/g, "")
                    )}
                  </TableCell>
                  <TableCell sx={{ border: "2px solid black", padding: "5px" }}>
                    {renderStatus(
                      JSON.stringify(entry.day_11).replace(/"/g, "")
                    )}
                  </TableCell>
                  <TableCell sx={{ border: "2px solid black", padding: "5px" }}>
                    {renderStatus(
                      JSON.stringify(entry.day_12).replace(/"/g, "")
                    )}
                  </TableCell>
                  <TableCell sx={{ border: "2px solid black", padding: "5px" }}>
                    {renderStatus(
                      JSON.stringify(entry.day_13).replace(/"/g, "")
                    )}
                  </TableCell>
                  <TableCell sx={{ border: "2px solid black", padding: "5px" }}>
                    {renderStatus(
                      JSON.stringify(entry.day_14).replace(/"/g, "")
                    )}
                  </TableCell>
                  <TableCell sx={{ border: "2px solid black", padding: "5px" }}>
                    {renderStatus(
                      JSON.stringify(entry.day_15).replace(/"/g, "")
                    )}
                  </TableCell>
                  <TableCell sx={{ border: "2px solid black", padding: "5px" }}>
                    {renderStatus(
                      JSON.stringify(entry.day_16).replace(/"/g, "")
                    )}
                  </TableCell>
                  <TableCell sx={{ border: "2px solid black", padding: "5px" }}>
                    {renderStatus(
                      JSON.stringify(entry.day_17).replace(/"/g, "")
                    )}
                  </TableCell>
                  <TableCell sx={{ border: "2px solid black", padding: "5px" }}>
                    {renderStatus(
                      JSON.stringify(entry.day_18).replace(/"/g, "")
                    )}
                  </TableCell>
                  <TableCell sx={{ border: "2px solid black", padding: "5px" }}>
                    {renderStatus(
                      JSON.stringify(entry.day_19).replace(/"/g, "")
                    )}
                  </TableCell>
                  <TableCell sx={{ border: "2px solid black", padding: "5px" }}>
                    {renderStatus(
                      JSON.stringify(entry.day_20).replace(/"/g, "")
                    )}
                  </TableCell>
                  <TableCell sx={{ border: "2px solid black", padding: "5px" }}>
                    {renderStatus(
                      JSON.stringify(entry.day_21).replace(/"/g, "")
                    )}
                  </TableCell>
                  <TableCell sx={{ border: "2px solid black", padding: "5px" }}>
                    {renderStatus(
                      JSON.stringify(entry.day_22).replace(/"/g, "")
                    )}
                  </TableCell>
                  <TableCell sx={{ border: "2px solid black", padding: "5px" }}>
                    {renderStatus(
                      JSON.stringify(entry.day_23).replace(/"/g, "")
                    )}
                  </TableCell>
                  <TableCell sx={{ border: "2px solid black", padding: "5px" }}>
                    {renderStatus(
                      JSON.stringify(entry.day_24).replace(/"/g, "")
                    )}
                  </TableCell>
                  <TableCell sx={{ border: "2px solid black", padding: "5px" }}>
                    {renderStatus(
                      JSON.stringify(entry.day_25).replace(/"/g, "")
                    )}
                  </TableCell>
                  <TableCell sx={{ border: "2px solid black", padding: "5px" }}>
                    {renderStatus(
                      JSON.stringify(entry.day_26).replace(/"/g, "")
                    )}
                  </TableCell>
                  <TableCell sx={{ border: "2px solid black", padding: "5px" }}>
                    {renderStatus(
                      JSON.stringify(entry.day_27).replace(/"/g, "")
                    )}
                  </TableCell>
                  <TableCell sx={{ border: "2px solid black", padding: "5px" }}>
                    {renderStatus(
                      JSON.stringify(entry.day_28).replace(/"/g, "")
                    )}
                  </TableCell>
                  <TableCell sx={{ border: "2px solid black", padding: "5px" }}>
                    {renderStatus(
                      JSON.stringify(entry.day_29).replace(/"/g, "")
                    )}
                  </TableCell>
                  <TableCell sx={{ border: "2px solid black", padding: "5px" }}>
                    {renderStatus(
                      JSON.stringify(entry.day_30).replace(/"/g, "")
                    )}
                  </TableCell>
                </TableRow>
              ))}{" "}
